import {createRedirUrl, extract, generateParamsHTML} from './redirect'
...
let defaultParams = {
  ...
  "created-since-days": {
    description: "The number of days back from today to filter by creation date.",
    exampleValue: "14",
    type: "number",
  },
  "updated-since-days": {
    description: "The number of days back from today to filter by last update date.",
    exampleValue: "14",
    type: "number",
  },
  "closed-since-days": {
...
export function createUrl(params) {
  return createRedirUrl("issue", params);
}

export function issueCheckAndRedirect() {
